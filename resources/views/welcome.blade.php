...
<body class="font-sans bg-gray-light text-text-main leading-relaxed">
    <header class="bg-primary text-white py-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center px-4">
            <a href="/" class="flex items-center">
                <img src="https://tecnologicosucre.edu.ec/web/wp-content/uploads/2025/02/logo_isu-bl.png" alt="ISUS Logo" class="h-12 mr-4 transition-transform duration-300 hover:scale-105">
                <span class="text-xl font-bold hidden md:block font-headings">Sistema de Egresados Institucional</span>
            </a>
            ...
            @if (Route::has('login'))
                <nav class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="text-white hover:underline flex items-center">
    ...
    <section class="py-16 md:py-24 bg-gradient-to-br from-blue-900 to-blue-500">
        <div class="container mx-auto text-center px-4">
            <h1 class="text-4xl md:text-5xl font-bold mb-6 text-white font-headings">Seguimiento Profesional de Egresados</h1>
            <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-blue-200">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('login') }}" class="bg-white text-blue-900 font-semibold rounded-md px-6 py-3 hover:bg-gray-200 transition-colors">
    ...
    <section id="" class="py-20 bg-white">
  <div class="container mx-auto px-6">
    ...
    <div class="grid gap-12 md:grid-cols-3 max-w-6xl mx-auto">
      <!-- Perfil Profesional -->
      <div
        class="bg-white rounded-3xl shadow-md p-8 flex flex-col hover:shadow-xl transition-shadow duration-300 h-full"
      >
        <div class="text-blue-600 text-6xl mb-6 flex-shrink-0">
          <svg
        ...
        <h3 class="text-2xl font-semibold mb-4 text-gray-900 font-headings text-center">
        ...
        <ul class="text-gray-600 space-y-3 list-inside list-disc text-base">
  ...
  <div class="container mx-auto px-6">
    ...
    <div class="grid gap-12 md:grid-cols-2 max-w-5xl mx-auto">
      <!-- Item 1 -->
      <div class="bg-white rounded-3xl shadow-lg p-8 flex items-start space-x-6 hover:shadow-xl transition-shadow duration-300">
        <div class="flex-shrink-0 bg-blue-100 rounded-full p-4 text-blue-600">
          <!-- Icono de conexión (cadena) -->
    ...
    <section class="py-16 bg-primary text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-6 font-headings">Únete a nuestra red profesional</h2>
    ...
    <footer class="bg-dark text-white py-12">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    <h4 class="font-semibold text-lg mb-4 font-headings">Enlaces útiles</h4>
                    <ul class="space-y-2 text-gray-300">
                        <li><a href="https://tecnologicosucre.edu.ec/" class="hover:underline" target="_blank">Portal ISUS</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/oferta-academica/" class="hover:underline">Oferta académica</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/postulate/" class="hover:underline">Postulate</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/category/noticias/" class="hover:underline">Noticias</a></li>
                    </ul>
                </div>
  ...
  <div class="text-gray-300 space-y-6 text-sm leading-relaxed">
    ...
    <div>
      <strong class="block mb-1">Campus sur</strong>
      <p>Av. Teodoro Gómez de la Torre S14 - 72 y Joaquín Gutiérrez</p>
    </div>

    <div>
      <strong class="block mb-1">Centro múltiple de institutos (CMI)</strong>
  ...
  <div class="flex space-x-6">
    <!-- Facebook -->
    <a href="https://www.facebook.com/SUCREInstitutooficial/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="text-gray-300 hover:text-blue-600 transition-colors duration-200">
    ...
    <!-- X (Twitter) -->
    <a href="https://x.com/SUCREInstituto" target="_blank" rel="noopener noreferrer" aria-label="X" class="text-gray-300 hover:text-sky-500 transition-colors duration-200">
      <svg fill="currentColor" class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true">
