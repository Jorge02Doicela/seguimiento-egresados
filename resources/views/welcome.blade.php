...
<head>
    ...
    <meta name="description"
        content="Sistema de seguimiento profesional de egresados del Instituto Superior Universitario Tecnológico Sucre">
    ...
    <style>
        ...
        .bg-dark {
            ...
            /* Example: A dark gray, adjust if you have a specific 'dark' color in your Tailwind config */
        }
    </style>
</head>
    ...
    <header class="bg-primary text-white py-4 shadow-md sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center px-4">
            <a href="/" class="flex items-center group" aria-label="Volver al inicio de SEI">
                <img src="https://tecnologicosucre.edu.ec/web/wp-content/uploads/2025/02/logo_isu-bl.png"
                    alt="ISUS Logo" class="h-12 mr-4 transition-transform duration-300 group-hover:scale-105">
                <span class="text-xl font-bold hidden md:block font-headings tracking-tight text-white">Sistema de
                    Egresados Institucional</span>
            </a>
                ...
                <nav class="flex items-center space-x-4" aria-label="Navegación principal">
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="btn btn-outline text-white hover:bg-white hover:text-primary transition-colors duration-200"
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1 inline" viewBox="0 0 20 20"
                                fill="currentColor">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-accent transition-colors duration-200"
    ...
    <main>
        <section class="py-20 md:py-32 bg-gradient-to-br from-primary-dark to-primary">
            <div class="container mx-auto text-center px-4">
                <h1 class="text-4xl md:text-6xl font-extrabold mb-6 text-white font-headings leading-tight">Seguimiento
                    Profesional de Egresados</h1>
                <p class="text-xl md:text-2xl mb-10 max-w-4xl mx-auto text-primary-lightest leading-relaxed">
                    Conectamos a nuestros graduados con oportunidades profesionales, acompañando su crecimiento laboral
                    y generando información estratégica que fortalece la calidad académica y potencia la empleabilidad
                    futura.
                </p>
          ...
          hover:bg-primary-dark hover:text-white hover:shadow-lg hover:scale-105"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 inline-block" viewBox="0 0 20 20"
                            fill="currentColor">
            ...
            <div class="container mx-auto px-6">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p class="text-lg text-gray-600">
                        Nuestra plataforma ofrece herramientas innovadoras y confiables para acompañar el crecimiento
                ...
                <div class="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
                    <div class="card flex flex-col items-center text-center h-full p-6">
                        <div class="text-primary-dark text-6xl mb-6 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" stroke-width="2" class="w-14 h-14 mx-auto">
                        ...
                        <p class="text-text-secondary mb-6 flex-grow">
                            Crea y mantiene un perfil detallado que refleja tu experiencia, habilidades y trayectoria
                            laboral, accesible para empleadores e instituciones.
                        </p>
                    ...
                    <div class="card flex flex-col items-center text-center h-full p-6">
                        ...
                        <p class="text-text-secondary mb-6 flex-grow">
                            Accede a análisis precisos y actualizados del mercado laboral, que te permiten tomar
                    ...
                    <div class="card flex flex-col items-center text-center h-full p-6">
                        ...
                        <p class="text-text-secondary mb-6 flex-grow">
                            Conéctate con otros egresados, accede a ofertas laborales exclusivas y participa en eventos
                            para ampliar tu red profesional.
                        </p>
                        <ul class="text-gray-600 space-y-3 list-inside list-disc text-left w-full pl-6">
        ...
        <section class="py-20 bg-gradient-to-br from-blue-50 to-blue-100">
            <div class="container mx-auto px-6">
                <div class="text-center max-w-3xl mx-auto mb-16">
                    <h2 class="text-4xl font-extrabold text-gray-900 mb-4 font-headings">Impacto en la Trayectoria
                        Profesional</h2>
                    <p class="text-lg text-gray-600">
                ...
                <div class="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
                    <div class="card flex items-start space-x-6 p-6">
                        <div class="flex-shrink-0 bg-blue-100 rounded-full p-4 text-blue-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M15 12H9m0 0a3 3 0 010-6h6a3 3 0 010 6m-6 0a3 3 0 00-6 0v3a3 3 0 006 0v-3z" />
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 mb-2 font-headings">Conexión directa con
                                empleadores</h3>
                            <p class="text-text-secondary leading-relaxed">
                                Facilitamos el acceso a oportunidades laborales relevantes, vinculando perfiles
                                especializados con empresas del sector tecnológico.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 mb-2 font-headings">Datos para decisiones
                                profesionales</h3>
                            <p class="text-text-secondary leading-relaxed">
                                Proveemos estadísticas actualizadas que permiten a los egresados conocer su valor en el
                                mercado y orientar su crecimiento profesional.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card flex items-start space-x-6 p-6">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 mb-2 font-headings">Desarrollo de
                                habilidades clave</h3>
                            <p class="text-text-secondary leading-relaxed">
                                Identificamos las competencias más demandadas para que nuestros egresados enfoquen su
                                aprendizaje y aumenten su competitividad.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card flex items-start space-x-6 p-6">
                        <div class="flex-shrink-0 bg-purple-100 rounded-full p-4 text-purple-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M8 10h.01M12 10h.01M16 10h.01M21 16v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h14l4 4" />
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-xl font-semibold text-gray-900 mb-2 font-headings">Comunicación permanente
                                con el instituto</h3>
                            <p class="text-text-secondary leading-relaxed">
                                Manténte informado con avisos sobre encuestas, eventos, convocatorias y novedades que
                                favorecen tu desarrollo profesional.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-4 text-center">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="{{ route('register') }}"
                        class="btn btn-accent text-lg px-8 py-3 transition-transform duration-300 hover:scale-105"
    ...
    <footer class="bg-dark text-white py-12">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <img src="https://tecnologicosucre.edu.ec/web/wp-content/uploads/2025/02/logo_isu-bl.png"
                        alt="ISUS Logo" class="h-12 mb-4">
                    <p class="mb-4 text-gray-300">
                        Instituto Superior Universitario Tecnológico Sucre<br>
                        Quito, Ecuador
                    </p>
                    <p class="text-sm italic text-gray-400">"Tu camino hacia el éxito académico y educación
                        profesional"</p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300">
                        <li><a href="https://tecnologicosucre.edu.ec/"
                                class="hover:underline hover:text-primary-light transition-colors duration-200"
                                target="_blank" rel="noopener noreferrer">Portal ISUS</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/oferta-academica/"
                                class="hover:underline hover:text-primary-light transition-colors duration-200"
                                target="_blank" rel="noopener noreferrer">Oferta académica</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/postulate/"
                                class="hover:underline hover:text-primary-light transition-colors duration-200"
                                target="_blank" rel="noopener noreferrer">Postulate</a></li>
                        <li><a href="https://tecnologicosucre.edu.ec/web/category/noticias/"
                                class="hover:underline hover:text-primary-light transition-colors duration-200"
                                target="_blank" rel="noopener noreferrer">Noticias</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-6">
                        <a href="https://www.facebook.com/SUCREInstitutooficial/" target="_blank"
                            ...
                            class="text-gray-300 hover:text-blue-500 transition-colors duration-200">
                        ...
                        <a href="https://x.com/SUCREInstituto" target="_blank" rel="noopener noreferrer"
                            aria-label="X (anteriormente Twitter)"
                            class="text-gray-300 hover:text-sky-400 transition-colors duration-200">
                            <svg fill="currentColor" class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <a href="https://www.instagram.com/sucreinstituto/" target="_blank" rel="noopener noreferrer"
                            aria-label="Instagram"
                            class="text-gray-300 hover:text-pink-500 transition-colors duration-200">
                            <svg fill="currentColor" class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                        ...
                        <a href="https://www.youtube.com/@tecnologicosucre5610/featured" target="_blank"
                            rel="noopener noreferrer" aria-label="YouTube"
                            class="text-gray-300 hover:text-red-600 transition-colors duration-200">
                            <svg fill="currentColor" class="h-6 w-6" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                    d="M10 15l5.19-3L10 9v6zm10-3c0 1.38-.56 2.61-1.48 3.5-.58.56-1.4.92-2.26.98-3.36.25-6.72.25-10.08 0-.86-.06-1.68-.42-2.26-.98A4.98 4.98 0 012 12a4.98 4.98 0 011.98-4.5c.58-.56 1.4-.92 2.26-.98 3.36-.25 6.72-.25 10.08 0 .86.06 1.68.42 2.26.98A4.98 4.98 0 0120 12z" />
                            </svg>
                        </a>
                    </div>
                </div>
