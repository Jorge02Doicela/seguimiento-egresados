...
<div class="container">
    ...
    <form action="{{ route('graduate.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="cohort_year" id="cohort_year" class="form-control" value="{{ old('cohort_year', $graduate->cohort_year) }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="company" id="company" class="form-control" value="{{ old('company', $graduate->company) }}">
        </div>

        <div class="mb-3">
            <label for="position" class="form-label">Cargo</label>
            <input type="text" name="position" id="position" class="form-control" value="{{ old('position', $graduate->position) }}">
        </div>

        <div class="mb-3">
            <label for="salary" class="form-label">Salario</label>
            <input type="number" step="0.01" name="salary" id="salary" class="form-control" value="{{ old('salary', $graduate->salary) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="url" name="portfolio_url" id="portfolio_url" class="form-control" value="{{ old('portfolio_url', $graduate->portfolio_url) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            @if ($graduate->cv_path)
                <small>Archivo actual: <a href="{{ asset('storage/' . $graduate->cv_path) }}" target="_blank">Ver CV</a></small>
            @endif
        </div>

        <div class="mb-3">
            <label for="country" class="form-label">País</label>
            <input type="text" name="country" id="country" class="form-control" value="{{ old('country', $graduate->country) }}">
        </div>

        <div class="mb-3">
            <label for="city" class="form-label">Ciudad</label>
            <input type="text" name="city" id="city" class="form-control" value="{{ old('city', $graduate->city) }}">
        </div>
