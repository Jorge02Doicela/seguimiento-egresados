    ...
    <div id="question-list">
        @foreach ($survey->questions as $index => $question)
            <div class="border p-3 mb-3">
                ...
                <div class="mb-2">
                    <label>Tipo:</label>
                    <select name="questions[{{ $index }}][type]" class="form-select" onchange="toggleOptions(this, {{ $index }})" required>
                ...
                <div class="row {{ $question->type !== 'scale' ? 'd-none' : '' }}" id="scale-{{ $index }}">
                    <div class="col">
                        ...
                        <input type="number" name="questions[{{ $index }}][scale_min]" class="form-control" min="1" max="10"
                            value="{{ $question->scale_min }}">
                    </div>
                    <div class="col">
                        <label>Escala máxima:</label>
                        <input type="number" name="questions[{{ $index }}][scale_max]" class="form-control" min="1" max="10"
