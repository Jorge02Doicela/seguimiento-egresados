            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        <input id="remember_me" name="remember" type="checkbox" class="h-4 w-4 text-primary focus:ring-primary border-secondary rounded-md cursor-pointer">
                        <label for="remember_me" class="ml-2 block text-sm text-text-secondary font-open-sans cursor-pointer">Recordar sesión</label>
                    </div>
