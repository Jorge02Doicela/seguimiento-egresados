        ...
        <div
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div id="employerFields" style="display: none;">
                    <h3 class="text-lg font-semibold text-text-primary mb-4 font-montserrat">
                        {{ __('Datos de la Empresa') }}</h3>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <x-text-input id="contact_name"
                                class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="contact_name" :value="old('contact_name')"
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M7 2a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2V4a2 2 0 00-2-2H7zm3 15a1 1 0 100-2 1 1 0 000 2z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            ...
                            <x-text-input id="website"
                                class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="url" name="website" :value="old('website')"
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M10 2a1 1 0 011 1v1h4a1 1 0 011 1v4a1 1 0 01-1 1h-1.586l1.293 1.293a1 1 0 01-1.414 1.414l-2-2a1 1 0 010-1.414l2-2a1 1 0 011.414 0H16V6h-4V5a1 1 0 011-1 1 1 0 001-1V3a1 1 0 00-1-1zm-6 2a1 1 0 011-1h4a1 1 0 011 1v1h4a1 1 0 011 1v4a1 1 0 01-1 1h-1.586l1.293 1.293a1 1 0 01-1.414 1.414l-2-2a1 1 0 010-1.414l2-2a1 1 0 011.414 0H16V6h-4V5a1 1 0 011-1 1 1 0 001-1V3a1 1 0 00-1-1z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                            <x-text-input id="sector"
                                class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="sector" :value="old('sector')"
                                placeholder="Por ejemplo: Tecnología, Educación" />
                        </div>
                        ...
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 6.027a8.001 8.001 0 0111.336 0L10 10.667 4.332 6.027z"
                                        clip-rule="evenodd" />
                                </svg>
                            </div>
                            <x-text-input id="country"
                                ...
                                placeholder="País donde se ubica la empresa" />
                        </div>
