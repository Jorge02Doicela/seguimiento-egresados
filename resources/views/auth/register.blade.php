<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col justify-center items-center bg-gray-50 p-4 sm:p-0"
        ...
        <div class="w-full sm:max-w-md px-6 py-8 bg-white shadow-2xl rounded-xl overflow-hidden backdrop-blur-sm bg-opacity-85 border border-primary-lightest transform transition-all duration-300 hover:scale-[1.01] hover:shadow-3xl">
            ...
            @if ($errors->any())
                <div class="mb-6 px-4 py-3 bg-error-light text-error-dark rounded-lg border border-error text-base font-open-sans">
                    <ul>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                {{-- Campo de Nombre --}}
                <div class="mb-6">
                    <x-input-label for="name" :value="__('Nombre completo')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                    <div class="relative rounded-lg shadow-sm">
                        ...
                        <x-text-input id="name" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                            type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Tu nombre completo" />
                    </div>
                    <x-input-error :messages="$errors->get('name')" class="mt-2 text-sm text-error font-open-sans" />
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative rounded-lg shadow-sm">
                        ...
                        <x-text-input id="email" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative rounded-lg shadow-sm">
                        ...
                        <x-text-input id="password" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative rounded-lg shadow-sm">
                        ...
                        <x-text-input id="password_confirmation" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                ...
                <div class="mb-6">
                    <x-input-label for="role" :value="__('Selecciona tu rol')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                    <div class="relative rounded-lg shadow-sm">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <select id="role" name="role" required class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary font-open-sans">
                ...
                <div id="employerFields" style="display: none;">
                    <h3 class="text-lg font-semibold text-text-primary mb-4 font-montserrat">{{ __('Datos de la Empresa') }}</h3>
                    <div class="mb-6">
                        <x-input-label for="company_name" :value="__('Nombre de la empresa')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="company_name" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="company_name" :value="old('company_name')" placeholder="Nombre de la empresa" />
                        </div>
                        <x-input-error :messages="$errors->get('company_name')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="contact_name" :value="__('Nombre del contacto')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                            ...
                            <x-text-input id="contact_name" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="contact_name" :value="old('contact_name')" placeholder="Nombre de la persona de contacto" />
                        </div>
                        <x-input-error :messages="$errors->get('contact_name')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="phone" :value="__('Teléfono')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="phone" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="phone" :value="old('phone')" placeholder="Número de teléfono" />
                        </div>
                        <x-input-error :messages="$errors->get('phone')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="address" :value="__('Dirección')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="address" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="address" :value="old('address')" placeholder="Dirección de la empresa" />
                        </div>
                        <x-input-error :messages="$errors->get('address')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="website" :value="__('Sitio web')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="website" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="url" name="website" :value="old('website')" placeholder="https://www.tuempresa.com" />
                        </div>
                        <p class="text-sm text-text-muted mt-1 font-open-sans">
                            {{ __('Puedes dejar este campo vacío si no tienes sitio web') }}
                        </p>
                        <x-input-error :messages="$errors->get('website')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="sector" :value="__('Sector')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="sector" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="sector" :value="old('sector')" placeholder="Por ejemplo: Tecnología, Educación" />
                        </div>
                        <x-input-error :messages="$errors->get('sector')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="country" :value="__('País')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <x-text-input id="country" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="country" :value="old('country')" placeholder="País donde se ubica la empresa" />
                        </div>
                        <x-input-error :messages="$errors->get('country')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>

                    <div class="mb-6">
                        <x-input-label for="city" :value="__('Ciudad')" class="block text-sm font-semibold text-text-secondary mb-2 font-montserrat" />
                        <div class="relative rounded-lg shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 6.027a8.001 8.001 0 0111.336 0L10 10.667 4.332 6.027z" clip-rule="evenodd" />
                            ...
                            <x-text-input id="city" class="block w-full pl-10 pr-3 py-2 border border-secondary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 font-open-sans"
                                type="text" name="city" :value="old('city')" placeholder="Ciudad donde se ubica la empresa" />
                        </div>
                        <x-input-error :messages="$errors->get('city')" class="mt-2 text-sm text-error font-open-sans" />
                    </div>
                </div>
...
<script>
    function toggleEmployerFields() {
        ...
        // Agrega 'required' si el rol es 'employer', quítalo si no lo es
